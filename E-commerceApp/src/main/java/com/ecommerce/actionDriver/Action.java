...
public class Action extends BaseClass implements ActionInterface {
	...
	@Override
	public String text(WebDriver driver, WebElement ele) {
		explicitWait(driver,ele,100);
		return ele.getText();
	}
	...
	@Override
	public boolean send(WebElement ele, String text) {
	...
	public String screenShot(WebDriver driver, String filename) {
		...
		String newImageString = "D:\\Anil\\JAVA_Selenium\\Selenium_Workspace\\E-commerceApp\\ScreenShot/" + filename + "_"
				+ dateName + ".png";
